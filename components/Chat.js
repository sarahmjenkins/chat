...
export default class Chat extends React.Component {
  ...
  // doesn't render text input to send a message if the app is offline
  ...
  // render ActionSheet: plus button with options to send picture/location
  renderCustomActions = (props) => {
    return <CustomActions {...props} />;
  };

  // render MapView with sender's location
